...
- TS: the signed token is added to the TS active token storage for the given SP
...
- TS: the encrypted signed TOKEN is base64 encoded for transport
      and send as body of the response (200 OK)  to the SP TOKEN request
...
- SP: the signed verified TOKEN is base 64 encoded
